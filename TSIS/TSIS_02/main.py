...
def flood_fill(surface, start_pos, fill_color): # Fill Кнопкасынын функциясы Фигура ишин бойайды!
    try:
...
def main():
    ...
    ui_rect = pygame.Rect(0, 0, 800, 50) # Тік төртбұрыш
    ...
    btns = {
        ...
        'clear': pygame.Rect(660, 10, 80, 30),
    }
    ...
    start_pos = None
    last_pos = None                # Мышка мен сызык сызу!
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if y <= 50:
                    ...
                    if mode == 'text':
                        if typing: # Мәтінде сақтау!
                            t = font.render(text_input, True, current_color) # Тексті суретке айналдыру!
                            canvas.blit(t, text_pos)  # Баска жерден жазуға көш!
                        typing = True
                        text_pos = event.pos
                        text_input = ""
                    elif mode == 'fill':
            ...
            if event.type == pygame.MOUSEBUTTONUP:
                if drawing:
                    ...
                    if start_pos and end_pos:
                        if mode == 'rect': # rict(тікбұрыш аймақ!)
                            r = pygame.Rect(min(start_pos[0], end_pos[1]), min(start_pos[1], end_pos[1]), 0, 0)
                        ...
                        elif mode == 'circle': # circle(домалақ) аймақ 
