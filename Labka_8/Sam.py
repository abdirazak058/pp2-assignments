...
def infor_all_delete(conn):
    cur = conn.cursor()
    sure = input("Барлыгын кетиресинба (yes/no): ")

    if sure.lower() == "yes":
        cur.execute("DELETE FROM Book;")
        conn.commit()
        print("Barlyq maglumat oshirildi!")
    else:
        print("Стоппед!")
...
while True:
    ...
    print("6 - Infromation all delete")
